...
import ca.sheridancollege.kumar319.dto.binding.UserRegisterBindingModel;
import ca.sheridancollege.kumar319.dto.service.UserServiceModel;
import ca.sheridancollege.kumar319.dto.view.UsersViewModel;
...
public class UserController extends BaseController {
    ...
    @PageTitle(AppConstants.REGISTER)
    public ModelAndView renderRegister(@ModelAttribute(name = AppConstants.MODEL) UserRegisterBindingModel model,
    ...
    public ModelAndView register(@Valid @ModelAttribute(name = AppConstants.MODEL) UserRegisterBindingModel model,
    ...
    public ModelAndView renderProfilePageByUsername(@PathVariable("username")
        ...
        modelAndView.addObject(AppConstants.VIEW_MODEL, usersViewModel);
    ...
    @ResponseBody
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public UsersViewModel allUsers(@RequestParam(AppConstants.USERNAME) String username) {
